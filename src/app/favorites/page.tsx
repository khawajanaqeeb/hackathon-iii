    ...
    <div>
      ...
      <div className="relative w-full h-[316px]">
        ...
        <Image
          ...
          height={41}
        />
        <h1 className="text-3xl font-black  relative top-20 text-center text-[#B88E2F] mb-6">Your Favorites</h1>
      </div>
      <div className="min-h-screen bg-[#FFF3E3] p-8">
      
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {favorites.map((item) => (
          <div key={item.slug} className="bg-white p-4 rounded-lg shadow-md">
            <Image 
              src={item.imageUrl} 
              alt={item.title} 
              width={300}  // You should specify width and height for Image
              height={200} 
